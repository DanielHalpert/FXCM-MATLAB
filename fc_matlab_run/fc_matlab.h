...
DECLDIR int __stdcall createEntryOrder(const char *sAccountID, int iAmount, const char *sBuySell, const char *tif, const char *instrument, const char* StopLimit, const double price, const char *ticketNum);
